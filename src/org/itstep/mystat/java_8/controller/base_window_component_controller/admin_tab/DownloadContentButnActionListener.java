...
public class DownloadContentButnActionListener extends BaseWindowComponentController
	...
	public void actionPerformed(ActionEvent e) {
		...
		File contentFolder = myOpenDialogFolderChooser.getSelectedFile();
		...
		if ((new BaseWindow(new DatabaseController(new Database("1", "База данных", newPartitions)))).getMyTree()
				.getModel() == null) {
